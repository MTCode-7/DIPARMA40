...
$GATEWAY_META = [
    ...
    'square'     => ['name' => 'Square 1',           'icon' => 'fas fa-square',          'color' => '#006AFF', 'currencies' => ['USD','EUR','GBP','CAD','AUD']],
    'square_online' => ['name' => 'Square 2 · Online', 'icon' => 'fas fa-store',        'color' => '#006AFF', 'currencies' => ['USD','EUR','GBP','CAD','AUD']],
