...
function pos_ops_sticker_rows(): array
{
    return [
        ...
        ['op' => 'capture', 'group' => 'hold', 'card' => true, 'exp' => true, 'cvv' => false, 'otp' => false, 'rrn' => true, 'appr' => true, 'pid' => true, 'amt' => 'flex_5m', 'ledger' => 'after_capture'],
...
function pos_sticker_amt($v, bool $ar): string
{
    $map = [
        ...
        'flex_5m' => $ar ? 'أقل/مساوٍ/أكثر · حد 5,000,000 USD' : 'Less/same/more · cap 5,000,000 USD',
