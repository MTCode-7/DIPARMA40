...
function pos_operation_catalog(): array
{
    return [
        ...
        'recurring' => [
            ...
            'amount_flexible' => false,
            'method' => 'purchase2d',
            'desc_ar' => 'تحصيل متكرر على نفس البطاقة عبر البوابة المختارة. بعد الموافقة يبقى المبلغ على نفس البوابة.',
            'desc_en' => 'Recurring charge on the same card via the selected gateway. After approval the funds stay on the same gateway.',
        ],
        'installment' => [
            'ar' => 'تقسيط',
            'en' => 'Installment',
            ...
            'amount_flexible' => false,
            'method' => 'purchase2d',
            'desc_ar' => 'تقسيط على البطاقة عبر البوابة. بعد الموافقة يبقى المبلغ على نفس البوابة.',
            'desc_en' => 'Card installment via the gateway. After approval the funds stay on the same gateway.',
        ],
        'crypto_purchase' => [
            'ar' => 'شراء كريبتو',
            'en' => 'Crypto purchase',
        ...
        'gift_card' => [
            ...
            'amount_flexible' => false,
            'method' => 'purchase2d',
            'desc_ar' => 'تحصيل بطاقة هدية عبر البوابة. بعد الموافقة يبقى المبلغ على نفس البوابة.',
            'desc_en' => 'Gift-card charge via the gateway. After approval the funds stay on the same gateway.',
        ],
        'wire_transfer' => [
            'ar' => 'حوالة',
            'en' => 'Wire transfer',
        ...
        'quasi_cash' => [
            ...
            'amount_flexible' => false,
            'method' => 'purchase2d',
            'desc_ar' => 'شبه نقدي على البطاقة. بعد الموافقة يبقى المبلغ على نفس البوابة.',
            'desc_en' => 'Quasi-cash on the card. After approval the funds stay on the same gateway.',
        ],
        'withdrawal_pos' => [
            'ar' => 'سحب عبر POS',
            'en' => 'POS Withdrawal',
