...
function pos_merchant_lines(): array
{
    $lines = [
        ...
        'company_10' => [
            'mcc' => '4722',
            'ar' => 'شركة 10 — خدمات سياحية، حجوزات، إيجارات، عقارات، فنادق',
            'en' => 'Company 10 — tourism, bookings, rentals, real estate, hotels',
            'item' => 'DI PARMA BUSINESSMAN SERVICES — tourism bookings rentals real estate hotels',
